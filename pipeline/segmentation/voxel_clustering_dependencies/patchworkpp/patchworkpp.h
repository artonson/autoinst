...
public:
    ...
    vector<int> ground_idcs; 
    vector<int> nonground_idcs;
    std::unordered_map<PointXYZ, int,PointXYZHash> point_dict;
    ...
    std::vector<int> get_ground_idcs();
    std::vector<int> get_nonground_idcs();
