...
class ApplyPose(Filter):
    ...
    def __call__(
        ...
        filtered_entry = DatasetEntry(
            data_entry.index, data_entry.pose, points, data_entry.intensity,data_entry.panoptic_labels,data_entry.semantic_labels,data_entry.instance_labels, data_entry.images
        )
