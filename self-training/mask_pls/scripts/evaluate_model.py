...
def main(w, save_testset, nuscenes):
    ...
    output_dir = '/media/cedric/Datasets1/semantic_kitti/ncut_labels_train1/'
    #output_dir = '/media/cedric/Datasets1/semantic_kitti/ncut_labels_train2/'
    
    for seq in [str(i).zfill(2) for i in list(range(0,19))]:
        out_folder = output_dir + seq
