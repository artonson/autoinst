...
class SemanticDataset(Dataset):
    def __init__(self, data_path, cfg_path, split="train", dataset="KITTI"):
        ...
        split = [7] ##add this in line 133 as we just want to test on this subset now 
        data_path = '/mnt/hdd/Datasets/semantic_kitti/sequences/'
    ...
    def __getitem__(self, index):
        ...
        if self.split == "test":
            ...
            sem_labels = np.zeros_like(ins_labels)
